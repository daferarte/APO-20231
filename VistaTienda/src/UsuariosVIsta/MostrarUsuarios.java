...
public class MostrarUsuarios extends javax.swing.JFrame {
    ...
    private UsuariosDAO interfaz;
    /**
     * Creates new form MostrarUsuarios
     */
    public MostrarUsuarios() throws RemoteException {
        initComponents();
        this.conexionRMI();
        this.jTable1.setModel(interfaz.MostrarUsuarios());
    }
    
    private void conexionRMI(){
        try{
            Registry registro=LocateRegistry.getRegistry("127.0.0.1",7777);
            interfaz =  (UsuariosDAO) registro.lookup("RemotoRMI");
        }catch(Exception e){
    ...
    private void initComponents() {
        ...
        setTitle("Tienda | Lista de usuarios");
